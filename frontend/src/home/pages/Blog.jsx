...
export const Blog = () => {
  ...
  useEffect(() => {
    const fetchBlogPost = async () => {
      try {
        const response = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/blog/${id}`);
  ...
  return (
    <HomeLayout>
      <div className="max-w-4xl mx-auto p-6">
        <h1 className="text-4xl mb-4">{blogPost.title}</h1>
        <h2 className="text-xl mb-6 text-gray-800">{blogPost.topic}</h2>
        <div className="text-md text-gray-800 leading-relaxed mb-6">
        ...
        <div className="flex justify-center">
          <blockquote
            ...
            data-instgrm-permalink={blogPost.reel_link}
            ...
            <div style={{ padding: '16px' }}>
              <a href={blogPost.reel_link} style={{ background: '#FFFFFF', lineHeight: '0', padding: '0 0', textAlign: 'center', textDecoration: 'none', width: '100%' }} target="_blank" rel="noopener noreferrer">
              ...
              <p style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', lineHeight: '17px', marginBottom: '0', marginTop: '8px', overflow: 'hidden', padding: '8px 0 7px', textAlign: 'center', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                <a href={blogPost.reel_link} style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', fontStyle: 'normal', fontWeight: 'normal', lineHeight: '17px', textDecoration: 'none' }} target="_blank" rel="noopener noreferrer">Una publicación compartida por Pana (@pana.app)</a>
              </p>
            </div>
          </blockquote>
        </div>
